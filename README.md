...
· Code fix: Modify selinux_check_access() to always return an error (-1, errno=EINVAL) when an unknown class or permission is encountered, regardless of the deny_unknown setting.
